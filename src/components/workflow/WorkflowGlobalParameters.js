...
class WorkflowGlobalParameters extends Component {
    ...
    getComponentByType = (type) => {
        switch (type) {
            ...
            case 'json':
                return (
                    <InputJson onValidate={this.handlers.onValidate} />
                );
            default:
                return (
                    <Input />
            ...
            >
                ...
                <List
                    ...
                    renderItem={(variable) => {
                        ...
                        const description = this.getType(variable) === 'json' ? (
                            <ReactJson
                ...
                >
                    ...
                    <Form.Item
                        ...
                        colon={false}
                    >
                        <Select defaultValue={selectedVar.type} value={selectedVar.type} onChange={this.handlers.onChange} style={{ width: '100%' }}>
