            ...
            <Form>
                <FlexBox flexDirection="column">
                    <FlexBox justifyContent="flex-end" style={{ padding: 8 }}>
                        ...
                        <DataSourceModal ref={(c) => { this.modalRef = c; }} validateTitle={validateTitle} visible={visible} onOk={onOk} dataSource={dataSource} onCancel={onCancel} onChange={onChange} onValid={onValid} />
                    </FlexBox>
